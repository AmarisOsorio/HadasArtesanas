...
public class ClaseConexion {
    ...
    private static final String user = "TinkerBell";
    private static final String contra = "TinkerBell";
    ...
    public static Connection getConexion() {
        try {
            ...
            Connection conexion = DriverManager.getConnection(URL, user, contra);
